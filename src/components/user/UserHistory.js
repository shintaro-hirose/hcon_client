            ...
            <List component="nav">
                {
                    (!results || results.length===0) ? (
                        ...
                        results.map((item,index) => {
                            ...
                            let thirdTime = "-";
                            let bestTime = "-";
                            if(item.firstTime && (item.firstDnfReason || (item.firstDnfReason === ""))){
                                firstTime = timeFormatter(item.firstTime, item.firstDnfReason);
                            }
                            if(item.secondTime && (item.secondDnfReason || (item.secondDnfReason === ""))){
                                secondTime = timeFormatter(item.secondTime, item.secondDnfReason);
                            }
                            if(item.thirdTime && (item.thirdDnfReason || (item.thirdDnfReason === ""))){
