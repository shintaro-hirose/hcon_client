    ...
    situation === "before" ? (
            ...
            >
              <Fade in={open}>
                <div className={classes.paper}>
                  <Typography className={classes.subTitle}>注意事項</Typography>
                  <Box textAlign="center" margin="0 30px 30px 30px">
                    <Typography className={classes.text}>
                      ・ラウンドが終了するまで試技の結果を公開しないでください
                      <br />
                      （参加したことは言ってOK）
                    </Typography>
                    <Typography className={classes.text}>
                  ...
                  <Grid container>
                    <Grid item sm={6} xs={12} align="center">
                      <Box marginBottom="10px">
                        {isMobile() ? (
                          <Button
                            component={Link}
                            to={`/ExibitionUseTimerPhone/breathOfSpring2020/round1`}
                            color="primary"
                            variant="outlined"
                          >
                            <TimerIcon />
                          ...
                          <Button
                            component={Link}
                            to={`/ExibitionUseTimer/breathOfSpring2020/round1`}
                            color="primary"
                            variant="outlined"
                          >
                            <TimerIcon />
                    ...
                    <Grid item sm={6} xs={12} align="center">
                      <Button
                        component={Link}
                        to={`/exibition/breathOfSpring2020/round1`}
                        color="primary"
                        variant="outlined"
                      >
                        <CreateIcon />
      ...
      <div>
        ...
        <div align="center">
          <Button
            component={Link}
            to="/exibitionResult/breathOfSpring2020/round1"
            variant="contained"
          >
            第1ラウンドの結果を見る
          </Button>
                  ...
                  <div className={classes.paper}>
                    ...
                    <Grid container>
                      <Grid item sm={6} xs={12} align="center">
                        <Box marginBottom="10px">
                          {isMobile() ? (
                            <Button
                              component={Link}
                              to={`/ExibitionUseTimerPhone/breathOfSpring2020/final`}
                              color="primary"
                              variant="outlined"
                            >
                              <TimerIcon />
                            ...
                            <Button
                              component={Link}
                              to={`/ExibitionUseTimer/breathOfSpring2020/final`}
                              color="primary"
                              variant="outlined"
                            >
                              <TimerIcon />
                      ...
                      <Grid item sm={6} xs={12} align="center">
                        <Button
                          component={Link}
                          to={`/exibition/breathOfSpring2020/final`}
                          color="primary"
                          variant="outlined"
                        >
                          <CreateIcon />
      ...
      <div>
        ...
        <Box align="center" marginBottom="20px">
          <Button
            component={Link}
            to="/exibitionAllResults/breathOfSpring2020"
            variant="contained"
            color="primary"
          >
            すべての結果を見る
    ...
    <div>
      <Paper className={classes.root}>
        <Box textAlign="center" marginBottom="30px">
          <img alt="harukazeLogo" src={harukazeLogo} className={classes.logo} />
        </Box>
        {exibitionMockup}
      </Paper>
    </div>
...
export default connect(mapStateToProps)(ExibitionHome);
