      ...
      <React.Fragment>
       ...
       <img 
        ...
        />
          ...
          <Typography variant="h5" align="center" >決勝の結果</Typography>
            
            <Box textAlign="left" margin="50px 50px"> 
              <Box >
                <Typography variant="h6" >1試技目: {contestData2.scrambles.first}</Typography>
              </Box>
              <Box margin="20px 0">
                <Typography variant="h6">2試技目: {contestData2.scrambles.second}</Typography>
              </Box>
              <Box margin="20px 0">
                <Typography variant="h6">3試技目: {contestData2.scrambles.third}</Typography>
              </Box>
            </Box>
            ...
            <Box textAlign="center" marginTop="50px">    
              <Typography variant="h5" align="center" > 第1ラウンドの結果</Typography>
            </Box>
            <Box textAlign="left" margin="50px 50px"> 
              <Box >
                <Typography variant="h6" >1試技目: {contestData1.scrambles.first}</Typography>
              </Box>
              <Box margin="20px 0">
                <Typography variant="h6">2試技目: {contestData1.scrambles.second}</Typography>
              </Box>
              <Box margin="20px 0">
                <Typography variant="h6">3試技目: {contestData1.scrambles.third}</Typography>
              </Box>
            </Box>
            <Box textAlign="center">
