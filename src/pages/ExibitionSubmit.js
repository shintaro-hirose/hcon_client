...
import { postExibitionResult, getExibitionScramble } from '../redux/actions/userActions';
...
function ExibitionSubmit(props) {
  ...
  const handleSubmit = (event) => {
    ...
    props.postExibitionResult(form, props.history);
  };
...
ExibitionSubmit.propTypes = {
  postExibitionResult: PropTypes.func.isRequired,
  getExibitionScramble: PropTypes.func.isRequired,
