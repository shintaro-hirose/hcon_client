    ...
    <Paper className={classes.paper}>
      ...
      <List component="nav">
        <div>
          ...
          <ListItem>
            <ListItemText
              primary="メールアドレス・パスワードが変更可能になりました"
              secondary="2020-03-03 12:00"
            />
          </ListItem>
          <Divider />
          <ListItem>
            <ListItemText
              primary="スマホ・タブレットのタイマーを実装しました。Androidはどうじゃろ..."
              secondary="2020-2-29 13:00"
            />
          </ListItem>
          <Divider />
          <ListItem>
            <ListItemText
              primary="画像のリサイズを導入。プロフィール画像を更新すると、初回ロードデータが約1/300に削減されます"
              secondary="2020-2-27 13:00"
            />
          </ListItem>
          {/* <Divider />
                    <ListItem > 
